#+TITLE:     Apache+MySQL+PHP源码包安装指南(Linux)[cn/en]
#+AUTHOR:    zrg
...
author: zrg
comments: false
description: 这是我在Linux环境下的Apache+MySQL+PHP源码包安装过程。内容适用于linux操作系统，仅供参考！
categories:
- turorial
tags:
- Apache
...
成功标志：
#+END_SRC
#+ATTR_HTML::heght 600px :width 480px
[[./images/apache-10.png]]
#+BEGIN_SRC emacs lisp
#make && make install ，成功标志：
#+END_SRC
#+ATTR_HTML::width 650px
[[./images/apache-11.png]]
: 至此，Apache安装成功
** 启动Apache
#+BEGIN_SRC emacs lisp
因为是源码包安装，所以只能执行下列命令：
